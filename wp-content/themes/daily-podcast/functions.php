...
define('INTERNO_IMG_DIR', INTERNO_THEME_ROOT . '/images');
...
function theme_add_scripts() {
    ...
    wp_enqueue_script( 'script-main', INTERNO_THEME_ROOT .'/script/script.js', array(), '1.0', true );
   }
...
function my_search_form( $form ) {
    ...
    <form class="form-search"
	      ...
	      id="searchform"
	      action="' . home_url( '/' ) . '" >
        <input type="text" placeholder="Search..." type="text" value="' . get_search_query() . '" name="s" id="s" >
        <button type="submit" type="search" id="searchsubmit"></button>
    </form>';
